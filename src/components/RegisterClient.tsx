    ...
    <div className="min-h-screen bg-kaleo-sand flex items-center justify-center py-12 px-4 pt-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-kaleo-charcoal/60">Join our community of Nepal explorers!</p>
        </div>
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h1 className="font-serif text-2xl text-kaleo-charcoal mb-6 text-center">Create Account</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm font-medium text-kaleo-charcoal mb-1 block">Full Name</label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-kaleo-charcoal/40" />
                <Input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your Name" className="pl-10" required />
              </div>
            </div>
            <div>
          ...
          <p className="text-center text-sm text-kaleo-charcoal/60 mt-6">
            Already have an account? <Link href="/login" className="text-kaleo-terracotta hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
